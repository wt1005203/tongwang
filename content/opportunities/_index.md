...
description: "Information for prospective graduate students, postdoctoral researchers, technicians, and undergraduate researchers interested in joining the Systems and Interactions of Microbiomes Lab (SIM Lab)."
weight: 50
sitemap:
  priority: 0.8
  weight: 0.6
...
No funded postdoctoral positions are currently available. However, prospective postdoctoral researchers are encouraged to contact us if they are interested in jointly developing an application for an external fellowship. Potential opportunities include [HFSP Postdoctoral Fellowship](https://www.hfsp.org/), [Schmidt Science Fellows](https://schmidtsciencefellows.org/), [EMBO Postdoctoral Fellowships](https://www.embo.org/funding/fellowships-grants-and-career-support/postdoctoral-fellowships/eligibility/), [NIH Postdoctoral Individual National Research Service Award (F32)](https://grants.nih.gov/funding/activity-codes/F32), and [NSF's Postdoctoral Research Fellowships](https://www.nsf.gov/funding/postdocs#postdoctoral-research-fellowships-599).

<!--Postdoctoral candidates with backgrounds in microbiology, computational biology, microbiome science, machine learning, ecological modeling, synthetic communities, or related areas are welcome to reach out. Please include your CV, a short statement of research interests, and representative publications or preprints.-->

### Research technicians and lab staff
No funded positions are currently available.
<!--We welcome inquiries from candidates interested in supporting microbiome experiments, microbial culturing, sequencing workflows, data analysis, and day-to-day lab operations.-->
